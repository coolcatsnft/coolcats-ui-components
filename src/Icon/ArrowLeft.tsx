...
const ArrowLeft: React.FC<React.PropsWithChildren<SvgProps>> = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 15" width='20' transform="rotate(180)" {...props}>
    <path 
      fillRule="evenodd" 
      clipRule="evenodd" 
