...
import { BinIcon, ProgressToTickIcon, YoutubeIcon } from '../Icon';
...
const BinButtonTemplate: StoryFn<typeof Button> = (args) => {
  return (
    <Button {...args} $circle>
      <BinIcon />
    </Button>
...
export const BinButton = BinButtonTemplate.bind({});
